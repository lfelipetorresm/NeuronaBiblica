...
epub_path = r"C:\Users\lfeli\OneDrive\Estudios Felipe Torres\MATERIAL\Neurona\Materiales PDF\ISAIAS - UN CUADERNO DE ESTUDIO PARA MAEST - Robert Harkrider.epub"
output_dir = r"C:\Users\lfeli\OneDrive\Estudios Felipe Torres\MATERIAL\Neurona\NeuronaBiblica\02_Exegesis\Isaias_Harkrider"
...
yaml_template = """---
titulo: "{clean_title}"
autor: "Robert Harkrider"
fuente: "Isaías - Un Cuaderno de Estudio para Maestros"
tipo: material_estudio
estado: Procesado
etiquetas: ["#Exegesis", "#Isaias", "#Profetas", "#Harkrider"]
---
...
terms_to_link = [
    ...
    "Isaías", "Jerusalén", "Judá", "Israel", "profecía", "salvación", "Mesías",
...
with zipfile.ZipFile(epub_path, 'r') as z:
    ...
    index_content = "# Índice Maestro: Isaías (Robert Harkrider)\n\n"
    ...
    with open(os.path.join(output_dir, '00_Indice_Isaias.md'), 'w', encoding='utf-8') as f:
        f.write(yaml_template.format(clean_title="Índice Isaías"))
